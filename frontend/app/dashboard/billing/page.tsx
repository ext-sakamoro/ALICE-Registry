...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['5 repositories', '1GB storage', 'Public repos only', 'Community support'] },
  { name: 'Pro', price: '$29/mo', features: ['Unlimited repositories', '50GB storage', 'Private repos', 'SDF diff visualization', 'Version history', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', 'On-premise option', 'Team management', 'Audit logs', 'SLA 99.99%', 'Dedicated support'] },
];
